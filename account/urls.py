...
app_name = 'account'
urlpatterns = [
    path(r'', cache_page(60)(views.account_profile), name='profile'),
    ...
    # 用户列表/详情
    path(r'users/', cache_page(60)(views.UserListView.as_view()), name='user_list'),
    ...
    path(r'user/detail/<str:username>/', cache_page(60)(views.UserDetailView.as_view()), name='user_detail'),
